...
AI エージェント時代のために設計されました。従来のダイアグラムツールは人間がアイコンを手動で配置し線を引く必要がありましたが、gospelo-diagrams は最初から AI エージェントが自律的に操作できるよう設計されています - JSON 定義を読み取り、プロフェッショナルなダイアグラムを生成し、人間のフィードバックに基づいて反復的に改善します。
