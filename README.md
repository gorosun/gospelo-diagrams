...
Built for the AI Agent era. While traditional diagramming tools require humans to manually place icons and draw lines, gospelo-diagrams is designed from the ground up for AI agents to operate autonomously - reading JSON definitions, generating professional diagrams, and iterating based on human feedback.

## Why gospelo-diagrams?
...
- **Multiple Output Formats**: SVG, standalone HTML, enriched JSON with metadata
...
```bash
# Using Bun
bun add gospelo-diagrams

# Using npm
npm install gospelo-diagrams
```
...
gospelo-diagrams render diagram.json output.html

# Render to SVG only
gospelo-diagrams svg diagram.json output.svg

# Add metadata for AI consumption
gospelo-diagrams enrich diagram.json enriched.json

# Output metadata only
gospelo-diagrams meta diagram.json --pretty
```

### Programmatic Usage

```typescript
import { renderStandalone, renderSvg, enrichDiagram } from 'gospelo-diagrams';

const diagram = {
  title: "My Architecture",
  nodes: [
    { id: "lambda", icon: "aws:lambda", label: "Function", position: [100, 100] },
...
See the [Icon Catalog](docs/ICON_CATALOG.md) for browsing and searching icons.
...
```bash
gospelo-diagrams preview diagram.json
# Output: Preview SVG generated: /tmp/diagram_preview_xxx.svg
```

## License

[MIT](https://github.com/gorosun/gospelo-diagrams/blob/main/LICENSE.md)

## Repository

https://github.com/gorosun/gospelo-diagrams
